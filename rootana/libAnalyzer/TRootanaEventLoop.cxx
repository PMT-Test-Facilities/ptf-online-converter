...
void PrintCurrentStats(){
  ...
  if((raTotalEventsProcessed%3000)==0){
...
TRootanaEventLoop::TRootanaEventLoop (){
  ...
  //fDirectoryString = std::string("/home1/midptf/packages/rootana/examples/rootfiles_separate");
...
void TRootanaEventLoop::OpenRootFile(int run, std::string midasFilename){
  ...
  //sprintf(filename, "%s%s", fDirectoryString.c_str(),filename.c_str());
