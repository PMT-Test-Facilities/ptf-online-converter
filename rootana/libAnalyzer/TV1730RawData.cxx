    ...
    TGenericData(bklen, bktype, name, pdata)
{
  ...
  if( (GetData32()[0] & 0xf0000000) != 0xa0000000){
    std::cerr << "V1730: First word has wrong identifier; first word = 0x" 
	      << std::hex << GetData32()[0] << std::dec << std::endl;
    std::cerr << "Size " << bklen << std::endl;
    std::cerr << "fff " << GetData32()[0] << " " << GetData32()[1]
	      << " " << GetData32()[2] << " " <<  GetData32()[3] << std::endl;
    return;
  }
