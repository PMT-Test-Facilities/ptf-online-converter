...
Definition at line 106 of file Roody.h.\index{Roody@{Roody}!EDrawDestination@{EDrawDestination}}
...
\index{Roody@{Roody}!Roody@{Roody}}
\subsubsection[{Roody}]{\setlength{\rightskip}{0pt plus 5cm}Roody::Roody (const TGWindow $\ast$ {\em p} = {\ttfamily NULL}, \/  UInt\_\-t {\em w} = {\ttfamily 800}, \/  UInt\_\-t {\em h} = {\ttfamily 800})}\label{classRoody_ad83246f782ed3b8fc2a0170abceb1814}


Definition at line 208 of file Roody.cxx.\index{Roody@{Roody}!$\sim$Roody@{$\sim$Roody}}
...
Referenced by Roody().\index{Roody@{Roody}!AddDataSource@{AddDataSource}}
...
Referenced by ConnectServer(), OpenNetDirectory(), OpenRootFile(), OpenXmlServer(), and ReopenSource().\index{Roody@{Roody}!AddHistogramToGroup@{AddHistogramToGroup}}
...
Definition at line 2241 of file Roody.cxx.

Referenced by AddToGroup(), and RestoreFile().\index{Roody@{Roody}!AddObjectToVec@{AddObjectToVec}}
...
Referenced by AddPadToVec(), DrawItemOnPad(), and ZoomOption().\index{Roody@{Roody}!AddPadToVec@{AddPadToVec}}
...
Referenced by RedrawCanvas(), and SetupZones().\index{Roody@{Roody}!AddPeakFind@{AddPeakFind}}
...
Referenced by Roody().\index{Roody@{Roody}!AddSetCut@{AddSetCut}}
...
Definition at line 948 of file Roody.cxx.

Referenced by Roody().\index{Roody@{Roody}!AddToGroup@{AddToGroup}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!AddZoomOption@{AddZoomOption}}
...
Referenced by Roody().\index{Roody@{Roody}!ApplyCanvasLimits@{ApplyCanvasLimits}}
...
Referenced by AddObjectToVec().\index{Roody@{Roody}!AxisLimits@{AxisLimits}}
...
Definition at line 985 of file Roody.cxx.\index{Roody@{Roody}!ClassDef@{ClassDef}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!CloseWindow@{CloseWindow}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!ConnectNetDirectory@{ConnectNetDirectory}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!ConnectServer@{ConnectServer}}
...
Definition at line 2768 of file Roody.cxx.

Referenced by ProcessMessage(), and RestoreFile().\index{Roody@{Roody}!DeleteGroup@{DeleteGroup}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!DrawGroup@{DrawGroup}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!DrawItem@{DrawItem}}
...
Referenced by PlotItems().\index{Roody@{Roody}!DrawItemOnPad@{DrawItemOnPad}}
...
Definition at line 1457 of file Roody.cxx.

Referenced by DrawItem(), DrawItemsOnNewCanvas(), and RestoreObjects().\index{Roody@{Roody}!DrawItemsOnNewCanvas@{DrawItemsOnNewCanvas}}
...
Referenced by DrawGroup(), and ProcessMessage().\index{Roody@{Roody}!GetFolderItems@{GetFolderItems}}
...
Referenced by DrawGroup(), ProcessMessage(), and SaveFile().\index{Roody@{Roody}!GetObject@{GetObject}}
...
Referenced by AddPadToVec(), ApplyCanvasLimits(), DrawItemOnPad(), RereadObject(), SaveFilePadContents(), and ZoomOption().\index{Roody@{Roody}!GetRunNumber@{GetRunNumber}}
...
Definition at line 2610 of file Roody.cxx.\index{Roody@{Roody}!GetZoneSetting@{GetZoneSetting}}
...
Referenced by SaveFile().\index{Roody@{Roody}!LayoutGUI@{LayoutGUI}}
...
Referenced by Roody().\index{Roody@{Roody}!LayoutMenuBar@{LayoutMenuBar}}
...
Referenced by LayoutGUI().\index{Roody@{Roody}!MakeNewCanvas@{MakeNewCanvas}}
\index{MakeNewCanvas@{MakeNewCanvas}!Roody@{Roody}}
\subsubsection[{MakeNewCanvas}]{\setlength{\rightskip}{0pt plus 5cm}TCanvas $\ast$ Roody::MakeNewCanvas (const char $\ast$ {\em title}, \/  int {\em columns}, \/  int {\em rows}, \/  int {\em topx} = {\ttfamily 0}, \/  int {\em topy} = {\ttfamily 0}, \/  int {\em width} = {\ttfamily 0}, \/  int {\em height} = {\ttfamily 0})\hspace{0.3cm}{\ttfamily  [private]}}\label{classRoody_af861c1507f04e150620b2fd6a4adb40d}


Definition at line 1673 of file Roody.cxx.

Referenced by DrawItem(), DrawItemsOnNewCanvas(), ProcessMessage(), RestoreFile(), and SetupZones().\index{Roody@{Roody}!MakeNewGroup@{MakeNewGroup}}
...
Referenced by PopupNewGroup(), and RestoreFile().\index{Roody@{Roody}!OpenFile@{OpenFile}}
...
Referenced by OpenFileDialog(), and RestoreFile().\index{Roody@{Roody}!OpenFileDialog@{OpenFileDialog}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!OpenHbookFile@{OpenHbookFile}}
...
Referenced by OpenFile().\index{Roody@{Roody}!OpenNetDirectory@{OpenNetDirectory}}
...
Referenced by ConnectNetDirectory().\index{Roody@{Roody}!OpenRefreshDialog@{OpenRefreshDialog}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!OpenRestoreDialog@{OpenRestoreDialog}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!OpenRootFile@{OpenRootFile}}
...
Definition at line 2438 of file Roody.cxx.

Referenced by OpenFile().\index{Roody@{Roody}!OpenSaveDialog@{OpenSaveDialog}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!OpenXmlServer@{OpenXmlServer}}
\index{OpenXmlServer@{OpenXmlServer}!Roody@{Roody}}
...
Referenced by ConnectServer().\index{Roody@{Roody}!OpenZoneDialog@{OpenZoneDialog}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!PeakFind@{PeakFind}}
...
Definition at line 1535 of file Roody.cxx.\index{Roody@{Roody}!PlotItems@{PlotItems}}
\index{PlotItems@{PlotItems}!Roody@{Roody}}
\subsubsection[{PlotItems}]{\setlength{\rightskip}{0pt plus 5cm}void Roody::PlotItems (const {\bf ItemVec} $\ast$ {\em items}, \/  {\bf EDrawDestination} {\em dest})\hspace{0.3cm}{\ttfamily  [private]}}\label{classRoody_aa64de3d1055473189bb2c783c1d5875f}


Definition at line 2339 of file Roody.cxx.

Referenced by ProcessMessage().\index{Roody@{Roody}!PopupGroup@{PopupGroup}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!PopupNewGroup@{PopupNewGroup}}
...
Referenced by AddToGroup(), and ProcessMessage().\index{Roody@{Roody}!PopupPlot@{PopupPlot}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!PopupPlotFolder@{PopupPlotFolder}}
...
Definition at line 1569 of file Roody.cxx.

Referenced by ProcessMessage().\index{Roody@{Roody}!PopupPlotSource@{PopupPlotSource}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!PopupTopGroup@{PopupTopGroup}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!ProcessMessage@{ProcessMessage}}
...
Definition at line 1821 of file Roody.cxx.\index{Roody@{Roody}!RedrawCanvas@{RedrawCanvas}}
...
Referenced by ProcessMessage(), and RefreshAll().\index{Roody@{Roody}!RefreshAll@{RefreshAll}}
\index{RefreshAll@{RefreshAll}!Roody@{Roody}}
\subsubsection[{RefreshAll}]{\setlength{\rightskip}{0pt plus 5cm}void Roody::RefreshAll ()}\label{classRoody_a649283dfe1b26d571571198d06e703bc}


Definition at line 2857 of file Roody.cxx.

Referenced by ProcessMessage(), and ResetAll().\index{Roody@{Roody}!ReopenSource@{ReopenSource}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!RereadObject@{RereadObject}}
...
Referenced by AddPadToVec().\index{Roody@{Roody}!ResetAll@{ResetAll}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!ResetItem@{ResetItem}}
...
Definition at line 2328 of file Roody.cxx.

Referenced by ResetMultiple().\index{Roody@{Roody}!ResetMultiple@{ResetMultiple}}
...
Referenced by ProcessMessage().\index{Roody@{Roody}!RestoreFile@{RestoreFile}}
...
Referenced by OpenRestoreDialog().\index{Roody@{Roody}!RestoreObjects@{RestoreObjects}}
...
Referenced by RestoreFile().\index{Roody@{Roody}!SaveFile@{SaveFile}}
...
Definition at line 633 of file Roody.cxx.

Referenced by OpenSaveDialog(), and ProcessMessage().\index{Roody@{Roody}!SaveFilePadContents@{SaveFilePadContents}}
...
Referenced by SaveFile().\index{Roody@{Roody}!SelectPad@{SelectPad}}
...
Definition at line 1428 of file Roody.cxx.\index{Roody@{Roody}!SetCut@{SetCut}}
...
Definition at line 957 of file Roody.cxx.\index{Roody@{Roody}!SetDestination@{SetDestination}}
...
Referenced by LayoutMenuBar(), MakeNewCanvas(), ProcessMessage(), and SetupZones().\index{Roody@{Roody}!SetRefreshRate@{SetRefreshRate}}
...
Referenced by OpenRefreshDialog(), ProcessMessage(), and RestoreFile().\index{Roody@{Roody}!SetupZones@{SetupZones}}
...
Referenced by OpenZoneDialog(), and ProcessMessage().\index{Roody@{Roody}!SetupZonesMenu@{SetupZonesMenu}}
...
Referenced by OpenZoneDialog(), ProcessMessage(), and RestoreFile().\index{Roody@{Roody}!SetZonesUser@{SetZonesUser}}
...
Definition at line 599 of file Roody.cxx.

Referenced by SetupZonesMenu().\index{Roody@{Roody}!StartUpdateTimer@{StartUpdateTimer}}
...
Referenced by RefreshAll(), Roody(), and SetRefreshRate().\index{Roody@{Roody}!UncheckAllZones@{UncheckAllZones}}
...
Referenced by ProcessMessage(), and SetupZonesMenu().\index{Roody@{Roody}!UpdateObjectClass@{UpdateObjectClass}}
...
Referenced by DrawItemOnPad().\index{Roody@{Roody}!ZoomOption@{ZoomOption}}
...
Definition at line 1289 of file Roody.cxx.
...
Referenced by Roody().\index{Roody@{Roody}!fCanvasColumns@{fCanvasColumns}}
...
Referenced by MakeNewCanvas(), RedrawCanvas(), SaveFile(), and SetupZones().\index{Roody@{Roody}!fCanvasCount@{fCanvasCount}}
...
Referenced by MakeNewCanvas(), and Roody().\index{Roody@{Roody}!fCanvasLimits@{fCanvasLimits}}
...
Referenced by AddObjectToVec(), and AxisLimits().\index{Roody@{Roody}!fCanvasRows@{fCanvasRows}}
...
Referenced by MakeNewCanvas(), RedrawCanvas(), SaveFile(), and SetupZones().\index{Roody@{Roody}!fContents@{fContents}}
...
Referenced by AddHistogramToGroup(), CloseSource(), ConnectServer(), DeleteGroup(), LayoutGUI(), MakeNewGroup(), OpenNetDirectory(), OpenRootFile(), OpenXmlServer(), ProcessMessage(), ReopenSource(), RestoreFile(), and UpdateObjectClass().\index{Roody@{Roody}!fDefaultDrawDestination@{fDefaultDrawDestination}}
...
Referenced by DrawItem(), and SetDestination().\index{Roody@{Roody}!fgPeakFindPanel@{fgPeakFindPanel}}
...
Referenced by PeakFind().\index{Roody@{Roody}!fGroupFolders@{fGroupFolders}}
...
Referenced by DeleteGroup(), MakeNewGroup(), PopupPlot(), ProcessMessage(), and SaveFile().\index{Roody@{Roody}!fHbookFiles@{fHbookFiles}}
...
Definition at line 210 of file Roody.h.\index{Roody@{Roody}!fMenuPlot@{fMenuPlot}}
...
Referenced by LayoutMenuBar(), and SetDestination().\index{Roody@{Roody}!fMenuRefresh@{fMenuRefresh}}
...
Referenced by LayoutMenuBar(), and SetRefreshRate().\index{Roody@{Roody}!fMenuZones@{fMenuZones}}
...
Referenced by LayoutMenuBar(), ProcessMessage(), SetupZonesMenu(), SetZonesUser(), and UncheckAllZones().\index{Roody@{Roody}!fOnlineFiles@{fOnlineFiles}}
...
Referenced by ConnectServer(), OpenXmlServer(), ResetAll(), and SaveFile().\index{Roody@{Roody}!fPopupMenu@{fPopupMenu}}
...
Referenced by PopupGroup(), PopupPlot(), PopupPlotFolder(), PopupPlotSource(), PopupTopGroup(), and Roody().\index{Roody@{Roody}!fRefreshButton@{fRefreshButton}}
...
Referenced by LayoutGUI(), and SetRefreshRate().\index{Roody@{Roody}!fReopenButton@{fReopenButton}}
...
Referenced by LayoutGUI().\index{Roody@{Roody}!fRootFiles@{fRootFiles}}
...
Referenced by OpenNetDirectory(), and ResetAll().\index{Roody@{Roody}!fStatusBar@{fStatusBar}}
...
Referenced by CloseSource(), ConnectServer(), GetObject(), LayoutGUI(), OpenFileDialog(), OpenRefreshDialog(), OpenRestoreDialog(), OpenSaveDialog(), OpenZoneDialog(), ProcessMessage(), ReopenSource(), RestoreFile(), Roody(), and SaveFile().\index{Roody@{Roody}!fTreeItemFiles@{fTreeItemFiles}}
...
Referenced by LayoutGUI(), OpenRootFile(), RestoreFile(), and SaveFile().\index{Roody@{Roody}!fTreeItemGroups@{fTreeItemGroups}}
...
Referenced by LayoutGUI(), MakeNewGroup(), ProcessMessage(), and RestoreFile().\index{Roody@{Roody}!fTreeItemOnline@{fTreeItemOnline}}
...
Referenced by ConnectServer(), LayoutGUI(), OpenNetDirectory(), and OpenXmlServer().\index{Roody@{Roody}!fUpdatePause@{fUpdatePause}}
...
Referenced by ProcessMessage(), Roody(), SetRefreshRate(), and StartUpdateTimer().\index{Roody@{Roody}!fUpdateTimer@{fUpdateTimer}}
...
Referenced by CloseWindow(), RefreshAll(), Roody(), StartUpdateTimer(), and $\sim$Roody().\index{Roody@{Roody}!fUpdateTimerSec@{fUpdateTimerSec}}
...
Referenced by ProcessMessage(), Roody(), SaveFile(), SetRefreshRate(), and StartUpdateTimer().\index{Roody@{Roody}!fXSave@{fXSave}}
...
Referenced by PopupPlot(), PopupPlotFolder(), and PopupPlotSource().\index{Roody@{Roody}!fYSave@{fYSave}}
...
Referenced by PopupPlot(), PopupPlotFolder(), and PopupPlotSource().\index{Roody@{Roody}!fZoneColumns@{fZoneColumns}}
...
Referenced by DrawItem(), ProcessMessage(), RestoreFile(), Roody(), SaveFile(), SetupZones(), SetupZonesMenu(), and SetZonesUser().\index{Roody@{Roody}!fZoneRows@{fZoneRows}}
...
Referenced by DrawItem(), ProcessMessage(), RestoreFile(), Roody(), SaveFile(), SetupZones(), SetupZonesMenu(), and SetZonesUser().\index{Roody@{Roody}!fZoomCanvas@{fZoomCanvas}}
