#ifndef TBRBRawDataMTS_hxx_seen
#define TBRBRawDataMTS_hxx_seen
...
class TBRBRawDataMTS: public TGenericData {

public:

  /// Constructor
  TBRBRawDataMTS(int bklen, int bktype, const char* name, void *pdata);
